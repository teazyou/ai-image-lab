export const meta = {
  ...
  phases: [{ title: 'Sharpen', detail: 'pool of ≤max_parallels_agents workers, each its group one image at a time, on Sonnet/low' }],
}
...
// One sub-agent per group, pinned to model: sonnet / effort: low — purely mechanical (run the
